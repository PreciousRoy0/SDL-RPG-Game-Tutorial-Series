...
public:
	...
	void OnMousUpEvent(void* sender, IEvent* ev)
	{
	...
	virtual void Initialize()
	{
		...
		spr.CalculateCellSize(Size(16, 16), 0);
		...
		spr2list.AddListener(Bind<TestState>(&TestState::OnMousUpEvent, this));
	}
