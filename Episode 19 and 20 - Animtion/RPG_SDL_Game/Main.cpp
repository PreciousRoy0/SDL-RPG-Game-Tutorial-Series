...
public:
	...
	virtual void Initialize()
	{
		...
		TheAssetManager::Pointer()->LoadAsset<SDL_TileSheet>("Media/tilemap_packed.png");
		SDL_TileSheet* m_AnimationSheet = TheAssetManager::Pointer()->GetAsset<SDL_TileSheet>("Media/tilemap_packed.png");

		//dont forget to calculate the tiles
		UiSheet->CalculateCellSize(Size(32, 32), 4);
		m_AnimationSheet->CalculateCellSize(Size(16, 16), 0);
