...
void EventListener::SetEvent(IEvent * ev)
{
...
void EventListener::AddListener(std::function<void(IEvent*)> func)
{
	m_Functions.push_back(func);
}

void EventListener::RemoveListener(std::function<void(IEvent*)> func)
{
