...
void SDL_TileSheet::SetCellSize(Size CellSize)
{
	m_CellSize = CellSize;
...
int SDL_TileSheet::GetCellWidth()
{
	return m_CellSize.Width;
}

int SDL_TileSheet::GetCellHeight()
{
	return m_CellSize.Height;
}

SDL_Rect SDL_TileSheet::TranslateCell(const int Cell)
{
	SDL_Rect res;
...
void SDL_TileSheet::Draw(const int cell, const Vector2 & location)
{
